## [第四十五章 法力的“编译器”](https://www.xxbiquge.com/11_11207/9076444.html)
readx();
  ...
  飘忽的眼神在一瞬间变得异常狂热和坚定。但是，这种坚定也只持续了一瞬间。转眼之间，她的眼神又黯淡下去：“可是啊……还我修元又有什么用呢……我还是有可能被夺走修为。”
  ...
  所谓编译器，就是能够将一种语言转化成另一种语言的机制。它可以将高级语言转换成汇编语言，将汇编语言转化成机械语言。
